  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-7 flex-wrap gap-4">
        <div>
          <h1 className="font-display text-2xl font-extrabold text-dark">Inventory</h1>
          <p className="text-sm text-vgray mt-1">{cars.length} total listings</p>
        </div>
        <Link
          href="/dashboard/inventory/new"
          className="flex items-center gap-2 bg-orange hover:bg-orange-dark text-white font-bold px-5 py-2.5 rounded-btn text-sm transition-colors shadow-md"
        >
          <Plus size={16} />
          Add new car
        </Link>
              ...
              {cars.length === 0 ? (
                <tr>
                  <td colSpan={6} className="text-center py-16 text-vgray">
                    ...
                    <Link
                      href="/dashboard/inventory/new"
                      className="inline-flex items-center gap-2 bg-orange text-white font-bold px-5 py-2.5 rounded-btn text-sm"
                    >
